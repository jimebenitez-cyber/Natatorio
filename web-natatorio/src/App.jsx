...
>>>>>>> 9170184d479a811eade4da8d2b837e4e7ad30619
                ...
                {view === 'formAlumno' && (
                    <div>
                        ...
                        <label>Nombre<span style={{ color: '#ef4444' }}>*</span></label><input value={formAlumno.nombre} onChange={e => setFormAlumno({ ...formAlumno, nombre: e.target.value })} required placeholder='Campo obligatorio' onKeyDown={(e) => e.key === 'Enter' && handleGuardarAlumno()} />
                        <label>Apellido<span style={{ color: '#ef4444' }}>*</span></label><input value={formAlumno.apellido} onChange={e => setFormAlumno({ ...formAlumno, apellido: e.target.value })} required placeholder='Campo obligatorio' onKeyDown={(e) => e.key === 'Enter' && handleGuardarAlumno()} />
                        <label>DNI<span style={{ color: '#ef4444' }}>*</span></label><input value={formAlumno.dni} onChange={e => setFormAlumno({ ...formAlumno, dni: e.target.value })} required placeholder='Campo obligatorio' onKeyDown={(e) => e.key === 'Enter' && handleGuardarAlumno()} />
                        ...
                        <label>Celular</label><input value={formAlumno.celular} onChange={e => setFormAlumno({ ...formAlumno, celular: e.target.value })} onKeyDown={(e) => e.key === 'Enter' && handleGuardarAlumno()} />
                        <label>Email</label><input value={formAlumno.gmail} onChange={e => setFormAlumno({ ...formAlumno, gmail: e.target.value })} onKeyDown={(e) => e.key === 'Enter' && handleGuardarAlumno()} />
                ...
                {view === 'buscarAlumno' && (
                    <div>
                        ...
                        <h2>Editar Alumno</h2>
                        <label>Ingrese DNI del Alumno</label>
                        <div style={{ display: 'flex', gap: '10px', marginTop: '15px' }}><input value={busquedaDni} onChange={e => setBusquedaDni(e.target.value)} placeholder="Ej: 33444555" style={{ marginBottom: 0 }} onKeyDown={(e) => e.key === 'Enter' && buscarAlumnoEditar()} /><button onClick={buscarAlumnoEditar} className="btn-primary" style={{ marginTop: 0, width: 'auto' }}>Buscar</button></div>
                    </div>
                )}
                ...
                {view === 'formProfesor' && (
                    <div>
                        ...
                        <label>Nombre<span style={{ color: '#ef4444' }}>*</span></label><input value={formProfesor.nombre} onChange={e => setFormProfesor({ ...formProfesor, nombre: e.target.value })} required placeholder='Campo obligatorio' onKeyDown={(e) => e.key === 'Enter' && handleGuardarProfesor()} />
                        <label>Apellido<span style={{ color: '#ef4444' }}>*</span></label><input value={formProfesor.apellido} onChange={e => setFormProfesor({ ...formProfesor, apellido: e.target.value })} required placeholder='Campo obligatorio' onKeyDown={(e) => e.key === 'Enter' && handleGuardarProfesor()} />
                        <label>DNI<span style={{ color: '#ef4444' }}>*</span></label><input value={formProfesor.dni} onChange={e => setFormProfesor({ ...formProfesor, dni: e.target.value })} required placeholder="Campo obligatorio" onKeyDown={(e) => e.key === 'Enter' && handleGuardarProfesor()} />
                        <button type="button" onClick={() => asignarDniTemporal('profesor')}
                            style={{ background: 'none', border: 'none', color: 'var(--primary)', textDecoration: 'underline', cursor: 'pointer', fontSize: '0.8rem', marginTop: '-12px', marginBottom: '15px', display: 'block', textAlign: 'left' }}>No tengo DNI</button>
                        <label>Teléfono</label><input value={formProfesor.telefono} onChange={e => setFormProfesor({ ...formProfesor, telefono: e.target.value })} onKeyDown={(e) => e.key === 'Enter' && handleGuardarProfesor()} />
                        <label>Especialidad</label><input value={formProfesor.especialidad} onChange={e => setFormProfesor({ ...formProfesor, especialidad: e.target.value })} onKeyDown={(e) => e.key === 'Enter' && handleGuardarProfesor()} />
                ...
                {view === 'buscarHistorial' && (
                    <div>
                        ...
                        <label>Ingrese DNI del Alumno</label>
                        <div style={{ display: 'flex', gap: '10px', marginTop: '15px' }}>
                            <input value={busquedaDni} onChange={e => setBusquedaDni(e.target.value)} placeholder="Ej: 33444555" style={{ marginBottom: 0 }} onKeyDown={(e) => e.key === 'Enter' && buscarHistorialPersonal()}/>
