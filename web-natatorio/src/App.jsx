    ...
    <div className="menu-container">
        ...
        {view === 'buscarProfe' && (
            <div>
                ...
                <div style={{display:'flex', gap:'10px', marginTop:'15px'}}><input value={busquedaDni} onChange={e=>setBusquedaDni(e.target.value)} placeholder="Ej: 12345678" style={{marginBottom:0}} onKeyDown={(e) => e.key === 'Enter' && buscarProfesor()}/><button onClick={buscarProfesor} className="btn-primary" style={{marginTop:0, width:'auto'}}>Buscar</button></div>
            </div>
        )}
